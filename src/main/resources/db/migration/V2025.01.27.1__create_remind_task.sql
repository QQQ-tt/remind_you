...
(
    ...
    type         int                                    not null comment '提醒类型:1单次,2多次,3无限',
    remind_time  datetime                               null comment '单次提醒触发时间',
    start_time   datetime                               null comment '多次提醒:开始时间',
    end_time     datetime                               null comment '多次提醒:结束时间',
    ...
    unit         enum ('minute', 'hour', 'day', 'week') not null comment '单位:分钟,小时,天,周',
